...
public class MPLevelUnlockPop : AWindow
{
    ...
    private void OnCoinClick()
    {
        ...
        {
            Debug.Log("Coins are not enough to unlock main level early.");
            return;
        }
    ...
    {
        Debug.Log("Ad unlock main level is not implemented yet.");
    }
    ...
    {
        Debug.Log("VIP unlock main level is not implemented yet.");
    }
